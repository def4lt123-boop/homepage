  ...
  return (
    <motion.a
      ...
      className="group pointer-events-auto relative block w-full overflow-hidden rounded-2xl
                 ...
                 hover:shadow-[inset_0_0_28px_rgba(255,255,255,0.06),0_18px_50px_-16px_rgba(41,151,255,0.22)]
                 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2997ff]/60
                 sm:w-64 md:w-72"
    ...
    >
      ...
      <span
        ...
        style={{
          background:
            "radial-gradient(120% 90% at 50% 110%, rgba(41,151,255,0.14), transparent 60%)",
        }}
      />
      ...
      >
        ...
        <span
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full
                     ...
                     group-hover:translate-x-0.5 group-hover:border-[#2997ff]/40
                     group-hover:bg-[#2997ff]/15 group-hover:text-[#6cb6ff]"
        >
          <svg
            width="13"
            height="13"
