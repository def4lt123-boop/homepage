...
function FlyingLetters({
  ...
  useFrame((state) => {
    ...
    const LIFT_PER_EXTRA_CARD = 0.5; // world units pro zusätzlicher gestapelter Card
    const TAGLINE_CLEARANCE = 0.55; // extra Puffer, damit "Entdecke meine Projekte" frei bleibt
